...
| 32     | `dup`        | Implemented | Duplicate file descriptor           |
| 33     | `dup2`       | Implemented | Duplicate to specific fd            |
...
| 78     | `getdents`   | Stub        | Read directory entries              |
...
| 217    | `getdents64` | Implemented | Read directory entries (64-bit)     |
